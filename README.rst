...
A requirement for all code merged into a stable release includes human review.
...
See the `demonstration <https://github.com/Tj-Ward/beautiful-brains/blob/main/Demonstration.ipynb/>`_ notebook.
